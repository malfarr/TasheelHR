  ...
  <div class="card card-new">
    <div class="card-hdr">
      <div class="card-count">
        <span class=""><?php print $variables['count']; ?></span>
      </div>      
      <?php if (isset($variables['actions']) && !empty($variables['actions'])) { ?>
        <div class="card-actions pull-right">
          <?php print implode(' ', $variables['actions']); ?>
        </div>
      <?php } ?> 
    </div>
    <div class="card-bdy row">
      <div class="col-sm-3 card-info">
        ...
        <div class="card-info-datetime">
          ...
          <div class="card-time"><?php print MED_FA_HOURGLASS_PURPLE; ?> <?php print $variables['created_time']; ?></div>
        </div>
      </div>  
      <div class="col-sm-9 card-content">
        <div class="card-content-description"><?php print $variables['description']; ?></div>
        <?php if (isset($variables['documents'])) { ?>
          <div class="card-content-documents"><?php print $variables['documents']; ?></div>
        <?php } ?>       
      </div>        
    </div>
  </div> 
