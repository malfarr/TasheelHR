  ...
  <div id="org-chart-block" class="block">    
    ...
    <div class="block-content push">
      <?php if ($variables['error'] == '') { ?>
        <div class="pull-right push-bit">
          <?php print l('Export Window', 'org-chart/' . $variables['entity'] . '/export', array('attributes' => array('class' => array('btn', 'btn-primary'), 'target' => '_blank'))) ?>      
        </div>
      <?php } ?>
