...
//                },
      ...
      // Initialize Chosen
      $('.select-chosen').chosen({width: "100%", disable_search_threshold: 6, search_contains: true});
      $('.select-chosen-dynamic').chosen({width: "100%", disable_search_threshold: 6, search_contains: true});
      $('.select-chosen-dynamic').parents('.form-item').addClass('form-item-chosen-dynamic');
    ...
    var handleNav = function () {
      ...
      submenuLinks.once().click(function () {
        var link = $(this);
    ...
    var interactiveBlocks = function () {
      ...
      $('[data-toggle="block-toggle-content"]').once().on('click', function () {
      ...
      $('[data-toggle="block-toggle-fullscreen"]').once().on('click', function () {
      ...
      // Hide block
      $('[data-toggle="block-hide"]').once().on('click', function () {
...
//      "sDom": "<'row'<'col-sm-12 col-xs-12'B>>" + 
//                    "<'row'<'col-sm-6 col-xs-5'lB><'col-sm-6 col-xs-7'f>r>t<'row'<'col-sm-5 hidden-xs'i><'col-sm-7 col-xs-12 clearfix'p>>",   
      $.extend(true, $.fn.dataTable.defaults, {
        "sDom": "<'row'<'col-sm-6 col-xs-12'lB><'col-sm-6 col-xs-12'f>r>t<'row'<'col-sm-5 col-xs-12'i><'col-sm-7 col-xs-12 clearfix'p>>",
    ...
    var slimscroll = function () {
      ...
      jQuery('.slimscroll').each(function () {
        ...
        var $color = $this.data('color') ? $this.data('color') : '#039be5';
