  ...
  (function ($, Drupal, window, document, undefined) {
    Drupal.behaviors.med_behavior = {
      attach: function (context, settings) {
        $('.logframe-item-edit-form').validate({
        ...
        $('.logframe-item-edit-form .form-submit').click(function () {
          for (var i in CKEDITOR.instances) {
            CKEDITOR.instances[i].updateElement();
            $.trim($('#' + i).val());
          }
          if ($(".logframe-item-edit-form").valid()) {
            $(".logframe-item-edit-form").submit();
          } else {
            return false;
          }
        });
...
<?php if (isset($form['code'])) {
    print drupal_render($form['code']);
  } ?>
<?php if (isset($form['color_code'])) {
    print drupal_render($form['color_code']);
  } ?>
<?php if (isset($form['description'])) {
    print drupal_render($form['description']);
  } ?>
<?php if (isset($form['notes'])) {
