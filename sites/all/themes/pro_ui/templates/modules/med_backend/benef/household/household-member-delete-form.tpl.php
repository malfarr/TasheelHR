  ...
  (function ($, Drupal, window, document, undefined) {
    Drupal.behaviors.med_behavior = {
      attach: function (context, settings) {
        $('.household-member-delete-form').validate({
        ...
        $('.household-member-delete-form .form-submit').click(function () {
          for (var i in CKEDITOR.instances) {
            CKEDITOR.instances[i].updateElement();
            $.trim($('#' + i).val());
          }
          if ($(".household-member-delete-form").valid()) {
            $(".household-member-delete-form").submit();
          } else {
            return false;
          }
        });
...
<?php print drupal_render($form['user_password']); ?>
