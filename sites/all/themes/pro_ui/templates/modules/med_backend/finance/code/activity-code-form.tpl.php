  ...
  (function ($, Drupal, window, document, undefined) {
    Drupal.behaviors.med_behavior = {
      attach: function (context, settings) {
        $('.activity-code-form .form-submit').removeClass('btn-success');
        $('.activity-code-form').validate({
        ...
        $('.activity-code-form .form-submit').click(function () {
          if ($(".activity-code-form").valid()) {
            $(".activity-code-form").submit();
          } else {
            return false;
          }
        });
