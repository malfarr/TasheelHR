  ...
  (function ($, Drupal, window, document, undefined) {
    Drupal.behaviors.med_behavior = {
      attach: function (context, settings) {
        $('.edit-trainer-form .form-submit').removeClass('btn-success');
        
        $('.edit-trainer-form').validate({
            ...
            partner: {
              required: {
                depends: function(element) {                        
                  return $(".form-item-implementing-partner input").is(":checked") == true;
                }
              }
            },
            institution: {
              required: {
                depends: function(element) {                        
                  return $(".form-item-implementing-partner input").is(":checked") == false;
                }
              }
            },
            email: {
